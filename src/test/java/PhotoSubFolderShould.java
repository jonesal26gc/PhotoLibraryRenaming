...
public class PhotoSubFolderShould {
    ...
    public void
    be_a_folder() {
        PhotoSubFolder photoSubFolder = new PhotoSubFolder("D:\\Family Photo Library\\2001-12-09 Dec01 Bournmouth (Sue & Paul's)");
    }

    @Test(expected = RuntimeException.class)
    public void
    throw_error_when_not_a_folder() {
        PhotoSubFolder photoSubFolder = new PhotoSubFolder("D:\\Family Photo Library\\2001-12-09 Dec01 Bournmouth");
    }
